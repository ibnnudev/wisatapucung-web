<x-app-layout>
    ...
    <x-breadcrumb :items="[
        ['route' => route('admin.organization.index'), 'name' => 'Organisasi'],
        ['route' => route('admin.organization.list-organization.create'), 'name' => 'Tambah Item Organisasi'],
    ]" />
    ...
    <x-card class="max-w-5xl mx-auto mb-4">
        ...
        <form action="{{ route('admin.organization.list-organization.store') }}" method="POST" class="mt-5 space-y-6"
