...
<header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between" aria-label="Global">
        <nav class="flex items-center justify-between p-6 lg:p-0 lg:px-8 w-full" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a type="button" data-dropdown-toggle="information-dropdown"
                    ...
                    request()->is('paket-wisata')
                        ...
                        : '' }}">Informasi</a>
                <!-- Dropdown menu -->
                <div id="information-dropdown"
                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="{{ route('user.information') }}"
                                class="block px-4 py-2 hover:bg-gray-100">Berita</a>
                        </li>
                        <li>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="{{ route('login') }}"
                    class="text-sm/6 font-semibold {{ $theme === 'dark' ? 'text-gray-900' : 'text-white' }}">Masuk
