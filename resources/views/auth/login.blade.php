        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 h-screen">
            <div
                ...
                <div class="absolute inset-0">
                    <img class="object-cover object-top w-full h-full"
                        src="https://cdn.pixabay.com/photo/2021/07/02/21/36/alpine-village-6382622_1280.jpg"
                ...
                <div class="relative">
                    <div class="w-full max-w-xl xl:w-full xl:mx-auto xl:pr-24 xl:max-w-xl">
                        <h3 class="text-4xl font-bold text-white">Wisata Edukasi Kalipucung <br
                                class="hidden xl:block" />Eksplorasi Pengalaman Menakjubkan</h3>
                        <ul class="grid grid-cols-1 mt-10 sm:grid-cols-2 gap-x-8 gap-y-4">
                            <li class="flex items-center space-x-3">
                                ...
                                <span class="text-lg font-medium text-white"> Paket Wisata </span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <div
                                    class="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                ...
                                <span class="text-lg font-medium text-white"> Penginapan </span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <div
                                    class="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                ...
                                <span class="text-lg font-medium text-white"> 120+ Lokasi Edukasi </span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <div
                                    class="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                ...
                                <span class="text-lg font-medium text-white"> Kegiatan Outdoor </span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl">Selamat datang kembali!</h2>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="mt-8">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                <button type="submit"
                                    class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-indigo-600 focus:outline-none hover:opacity-80 focus:opacity-80">
                                    Masuk
                                </button>
                            </div>
                        </div>
