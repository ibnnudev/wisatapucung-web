            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="max-w-3xl mx-auto text-center">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">
                        Dibalik Suksesnya Dusun
                    </h2>
                    <p class="max-w-2xl mx-auto mt-4 text-xl text-gray-600">
                        Kami adalah pemuda dusun kalipucung yang bergerak dalam bidang sosial dan keagamaan
                    </p>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900">
                            Kami berdedikasi mengembangkan potensi pemuda
                        </h1>
                        <p class="mb-8 leading-relaxed">
                            Kami adalah pemuda dusun kalipucung yang bergerak dalam bidang sosial dan keagamaan yang
                            berdedikasi untuk mengembangkan potensi pemuda dusun kalipucung agar lebih baik lagi
                            kedepannya dan lebih maju
                        </p>
                        <p class="mb-8 leading-relaxed">
                            Kami juga memiliki program-program yang bertujuan untuk membantu
                            dan memberikan edukasi kepada masyarakat sekitar.
                        </p>
                    </div>
