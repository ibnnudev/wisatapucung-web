                ...
                <article class="flex max-w-xl flex-col items-start justify-between">
                    ...
                    <div class="group relative">
                        <h3 class="mt-3 text-lg/6 font-semibold text-gray-900 group-hover:text-gray-600">
                            <a href="#">
                                <span class="absolute inset-0"></span>
                                Tari tradisional yang masih dilestarikan
                            </a>
                        </h3>
                        <p class="mt-5 line-clamp-3 text-sm/6 text-gray-600">
                            Tari tradisional merupakan salah satu budaya yang masih dilestarikan oleh masyarakat
                            Indonesia.
                            Tari tradisional memiliki nilai seni yang tinggi dan memiliki makna yang mendalam.
                        </p>
                    </div>
                    <div class="relative mt-8 flex items-center gap-x-4">
                        <img src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
