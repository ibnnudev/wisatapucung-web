                ...
                <div class="flex flex-col justify-between lg:py-5">
                    <div>
                        ...
                        <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
                            Layanan pelanggan kami siap membantu Anda. Silakan hubungi kami melalui formulir di bawah
                            ini.
                        </p>
                    ...
                    {{-- <div class="hidden md:mt-auto md:block">
                        ...
                        <blockquote class="mt-6">
                            <p class="text-lg leading-relaxed text-white">
                                Pelayanan yang sangat memuaskan, saya sangat puas dengan layanan yang diberikan oleh tim
                                Wisata Edukasi Dusun Kalipucung. Terima kasih banyak telah.
                            </p>
                        </blockquote>
                    ...
                    <div class="overflow-hidden bg-white rounded-md">
                        <div class="p-6 sm:p-10">
                            ...
                            <p class="mt-4 text-base text-gray-600">
                                Layanan pelanggan kami siap membantu Anda. Silakan hubungi kami melalui formulir di
                                bawah
                                ini.
                            </p>
                ...
                <div class="md:hidden">
                    ...
                    <blockquote class="mt-6">
                        <p class="text-lg leading-relaxed text-white">You made it so simple. My new site is so much
                            faster and easier to work with than my old site. I just choose the page, make the change and
                            click save.</p>
                    </blockquote>
